import {
  ...
  dangerColor,
  roseColor
} from "assets/jss/MainClasses.jsx";
...
const buttonStyle = {
  button: {
    ...
    color: "#FFFFFF",
    boxShadow:
      "0 2px 2px 0 #0078d7, 0 3px 1px -2px #0078d7, 0 1px 5px 0 #0078d7",
    border: "none",
    borderRadius: "3px",
    position: "relative",
    padding: "12px 30px",
    ...
    "&:hover,&:focus": {
      ...
      boxShadow:
        "0 14px 26px -12px 0078d7, 0 4px 23px 0px rgba(0, 0, 0, 0.12), 0 8px 10px -5px 0078d7"
    },
  ...
  primary: {
    ...
    boxShadow:
      "0 2px 2px #00078d7, 0 3px 1px -2px #0078d7, 0 1px 5px 0 #0078d7",
    "&:hover,&:focus": {
      backgroundColor: primaryColor,
      boxShadow:
        "0 14px 26px -12px #0078d7, 0 4px 23px 0px #0078d7, 0 8px 10px -5px #0078d7"
    }
  },
  info: {
